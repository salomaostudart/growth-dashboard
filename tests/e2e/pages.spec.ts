...
const pages = [
  {
    ...
    kpis: 6,
    charts: ['wp-traffic-chart', 'wp-device-chart'],
  },
  { path: '/seo', title: 'SEO', kpis: 4, charts: ['seo-queries-chart', 'seo-position-chart'] },
  {
    ...
    title: 'Email',
    kpis: 5,
    charts: ['email-campaigns-chart', 'email-heatmap-chart'],
  },
  {
    path: '/social',
    title: 'Social',
    kpis: 4,
    charts: ['social-followers-chart', 'social-referral-chart'],
  },
  {
    path: '/crm-pipeline',
    title: 'CRM',
    kpis: 5,
    charts: ['crm-funnel-chart', 'crm-velocity-chart'],
  },
  {
    path: '/martech-health',
    title: 'Martech',
    kpis: 6,
    charts: ['martech-uptime-chart', 'martech-automation-chart'],
  },
];
